...
CREATE SEQUENCE "Library Management"."Publications_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE "Library Management"."Publications_id_seq" OWNED BY "Library Management"."Publications".id;

ALTER TABLE ONLY "Library Management"."Publications"
  ALTER COLUMN id SET DEFAULT nextval('"Library Management"."Publications_id_seq"'::regclass);
...
SELECT pg_catalog.setval('"Library Management"."Authors_id_seq"', 14, true);

SELECT pg_catalog.setval('"Library Management"."Publications_id_seq"', 65, true);

SELECT pg_catalog.setval('"Library Management"."Publishers_id_seq"', 3, true);

SELECT pg_catalog.setval('"Library Management"."Checkouts_id_seq"', 1, false);

SELECT pg_catalog.setval('"Library Management"."Items_id_seq"', 117, true);

SELECT pg_catalog.setval('"Library Management"."Patrons_id_seq"', 30, true);
